...
describe('DefaultLoggingConfig', function (): void {
    ...
    beforeEach(function (): void {
        unset($_ENV['LOG_PATH'], $_ENV['LOG_STRATEGY'], $_ENV['LOG_BUFFER_SIZE']);
    });
    ...
    it('implements LoggingConfigInterface', function (): void {
        expect(makeTestLoggingConfig())->toBeInstanceOf(LoggingConfigInterface::class);
    });
    ...
    it('reads log settings from env vars', function (): void {
